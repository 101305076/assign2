  ...
  case GAME_RUN:
    ...
    if (leftCar2X > width) {
      ...
      if (rightCar2X < 0) {
        ...
        if (
        // car1 hitTest
        (rightCar1X < frogX+16 && rightCar1X > frogX-16 && rightCar1Y > frogY-32 && rightCar1Y < frogY+32)||
          // car2 hitTest
        (rightCar2X < frogX+16 && rightCar2X > frogX-16 && rightCar2Y > frogY-32 && rightCar2Y < frogY+32)||
          // car3 hitTest
        (leftCar1X < frogX+16 && leftCar1X > frogX-16 && leftCar1Y > frogY-32 && leftCar1Y < frogY+32)||  
          // car4 hitTest
        (leftCar2X < frogX+16 && leftCar2X > frogX-16 && leftCar2Y > frogY-32 && leftCar2Y < frogY+32)
          ) {
          if (life > 0) {
            currentTime = millis();
